...
<asp:Content ID="Content4" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
   ...
   <div id="divRow" runat="server" class="row">
       ...
       <div class="col-md-3 col-sm-4">
			...
			<div class="product_price-promos">
                <asp:Label ID="Label2" runat="server" CssClass="text-center" Text="$50:00"></asp:Label>
            </div>
		</div>
       <div class="col-md-3 col-sm-4" >
			<div class="">
				<asp:Image ID="Image2" runat="server" Height="200px" ImageUrl="~/imgs/Logo.jpg" Width="150px" />
			</div>
			<div class="product_info">
       ...
       <div class="col-md-3 col-sm-4" >
			<div class="">
				<asp:Image ID="Image3" runat="server" Height="200px" ImageUrl="~/imgs/Logo.jpg" Width="150px" />
			</div>
			<div class="product_info">
       ...
       <div class="col-md-3 col-sm-4">
			<div class="">
				<asp:Image ID="Image4" runat="server" Height="200px" ImageUrl="~/imgs/Logo.jpg" Width="150px" />
			</div>
			<div class="product_info">
        ...
        <div class="col-md-3 col-sm-4">
			<div class="">
				<asp:Image ID="Image5" runat="server" Height="200px" ImageUrl="~/imgs/Logo.jpg" Width="150px" />
			</div>
			<div class="product_info">
        ...
        <div class="col-md-3 col-sm-4">
			<div class="">
				<asp:Image ID="Image6" runat="server" Height="200px" ImageUrl="~/imgs/Logo.jpg" Width="150px" />
			</div>
			<div class="product_info">
        ...
        <div class="col-md-3 col-sm-4">
			<div class="">
				<asp:Image ID="Image7" runat="server" Height="200px" ImageUrl="~/imgs/Logo.jpg" Width="150px" />
			</div>
			<div class="product_info">
        ...
        <div class="col-md-3 col-sm-4">
			<div class="">
				<asp:Image ID="Image8" runat="server" Height="200px" ImageUrl="~/imgs/Logo.jpg" Width="150px" />
			</div>
			<div class="product_info">
