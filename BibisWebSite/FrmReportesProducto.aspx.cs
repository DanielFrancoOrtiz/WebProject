...
public partial class FrmReportesProducto : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ReportDataSource fuente = new ReportDataSource("ProductosDataSet", new DaoProducto().ConsultarTodos());
